...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_3fc227422c3e90580a4523e4eb2d5bf23e32448349778fc90514bc0bf12534d2');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_3fc227422c3e90580a4523e4eb2d5bf23e32448349778fc90514bc0bf12534d2');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_3fc227422c3e90580a4523e4eb2d5bf23e32448349778fc90514bc0bf12534d2');
        ...
        $f->setProxyDir('/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod',
            ...
            'debug.container.dump' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/sessions',
            ...
            'router.resource' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/test.com/public_html/xxxxxx/cableonda-admin/app/cache/prod/doctrine/orm/Proxies',
